...
- [공통 진입점 (invoke/alarm)](claude-code/bctrans-allcone/branch/addComment/claude-ref/tss-flow/invoke-alarm-entry.md)
...
| 터미널 이벤트 | `GateIn`, `BlockIn`, `JobDone`, `GateOut`, `GroupOrderGateIn` 등 | [TerminalEvent.md](claude-code/bctrans-allcone/branch/addComment/claude-ref/tss-flow/TerminalEvent.md) |
