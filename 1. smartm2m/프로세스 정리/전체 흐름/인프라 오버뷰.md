...
|--------|------|-----------|-------------|------|
| BaaS (Blockchain as a Service) | 블록체인 | 우리 회사 | 외부 | 운송 데이터 중계 + 고유키 발급 |
| Terminal Operating System | TOS | 각 터미널 | 내부 | 터미널 운영 시스템 (컨테이너/선박/야드 관리) |
| Terminal Agent | TA | 우리 회사 | 내부 | TOS ↔ 블록체인 연결 어댑터. 터미널마다 1개씩 |
...
| e-Slip (인수도증) | 터미널에서 발급하는 전자 인수도증. 운송 진행 상황이 기록됨 |
| PIN_NO | EDI망(VBS)에서 BaaS가 발급하는 운송건 고유키 |
| DOC_KEY | 블록체인 망(TSS)에서 BaaS가 발급하는 운송건 고유키 |
